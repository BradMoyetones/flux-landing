...
export default async function DownloadPage() {
    const [latestRelease, allReleases] = await Promise.all([getLatestRelease(), getAllReleases()]);

    return (
        <div className="mx-auto max-w-6xl px-6">
            {/* Page header */}
            <section className="pt-16 pb-12 text-center">
                <h1 className="gradient-text text-4xl sm:text-5xl font-bold tracking-tight mb-4">Descargas</h1>
                <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
                    Descarga Flux para tu plataforma. Disponible para macOS, Windows y Linux.
                </p>
            </section>
            ...
            {latestRelease ? (
                ...
                <section className="py-24 text-center">
                    <div className="bg-card border mx-auto max-w-md rounded-2xl p-8">
                        ...
                        <h2 className="text-lg font-semibold text-foreground mb-2">No se encontraron versiones</h2>
                        <p className="text-sm text-foreground-subtle">
                            No pudimos obtener las versiones de Flux en este momento. Por favor, inténtalo de nuevo más
                            tarde o visita nuestro{' '}
                            <a
