...
export const mdxComponents = {
    h1: ({ className, children, id, ...props }: React.ComponentProps<"h1">) => {
        ...
        return (
            <h1
                id={headingId}
                className={cn(
                    "mt-2 scroll-m-28 font-outfit text-3xl font-bold tracking-tight",
                    className
                )}
                {...props}
            >
    ...
    h2: ({ className, children, id, ...props }: React.ComponentProps<"h2">) => {
        ...
        return (
            <h2
                id={headingId}
                className={cn(
                    "[&+]*:[code]:text-xl mt-10 scroll-m-28 font-outfit text-xl font-medium tracking-tight first:mt-0 lg:mt-12 [&+.steps]:mt-0! [&+.steps>h3]:mt-4! [&+h3]:mt-6! [&+p]:mt-4!",
                    className
                )}
                {...props}
            >
    ...
    h3: ({ className, children, id, ...props }: React.ComponentProps<"h3">) => {
        ...
        return (
            <h3
                id={headingId}
                className={cn(
                    "mt-12 scroll-m-28 font-outfit text-lg font-medium tracking-tight [&+p]:mt-4! *:[code]:text-xl",
                    className
                )}
                {...props}
            >
    ...
    h4: ({ className, children, id, ...props }: React.ComponentProps<"h4">) => {
        ...
        return (
            <h4
                id={headingId}
                className={cn(
                    "mt-8 scroll-m-28 font-outfit text-base font-medium tracking-tight",
                    className
                )}
                {...props}
            >
    ...
    Step: ({ className, ...props }: React.ComponentProps<"h3">) => (
        <h3
            className={cn(
                "mt-8 scroll-m-32 font-outfit text-lg font-medium tracking-tight",
                className
            )}
            {...props}
        />
    ...
    TabsContent: ({
        ...
        <TabsContent
            className={cn(
                "relative [&_h3.font-outfit]:text-base [&_h3.font-outfit]:font-medium *:[figure]:first:mt-0 [&>.steps]:mt-6",
                className
            )}
            {...props}
        />
