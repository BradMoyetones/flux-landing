...
const FEATURES = [
    {
        title: '100% Local',
        description: 'Tus datos nunca salen de tu máquina. Sin servidores, sin latencia, sin dependencias en la nube.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
    ...
    },
    {
        ...
        description: 'Agrega nuevos Steps sin tocar el núcleo. Cada integración es un módulo aislado y reutilizable.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
    ...
    },
    {
        ...
        description: 'Ejecuta en macOS, Windows y Linux de manera nativa. Un solo binario, sin Docker, sin VMs.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
...
export function FeaturesSection() {
    ...
    useGSAP(
        () => {
            if (!sectionRef.current || !gridRef.current || !headerRef.current) return;
