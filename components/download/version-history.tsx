    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    <span className="text-xs text-foreground hidden sm:inline">{formattedDate}</span>
                ...
                {isOpen && (
                    ...
                    >
                        <div className="border-t border-border px-5 py-5">
                            ...
                            <p className="text-xs text-foreground mb-4 sm:hidden">{formattedDate}</p>
...
export function VersionHistory({ releases }: VersionHistoryProps) {
    ...
    if (previousReleases.length === 0) {
        return (
            <section>
                <h2 className="text-xl font-semibold text-muted-foreground mb-6">Versiones anteriores</h2>
                <p className="text-sm text-foreground">No hay versiones anteriores disponibles.</p>
            </section>
        );
    }
