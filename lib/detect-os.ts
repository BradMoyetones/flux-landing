...
function getSuggestedAssetKey(os: DetectedPlatform['os'], arch: DetectedPlatform['arch']): string | null {
    if (os === 'macos') {
...
function getLabel(os: DetectedPlatform['os'], arch: DetectedPlatform['arch']): string {
    if (os === 'macos') {
