...
export function SmartDownloadButton({
  ...
  if (isLoading) {
    return (
      <div
        className={`animate-pulse-glow inline-flex items-center gap-3 rounded-xl bg-accent/20 ${sizeClass}`}
      >
        <div className={`rounded-full bg-accent/40 ${iconClass}`} />
  ...
  return (
    <Link href={href} passHref legacyBehavior>
      <motion.a
        className={`group inline-flex items-center gap-3 rounded-xl bg-accent font-medium text-white shadow-lg transition-colors hover:bg-accent-hover glow ${sizeClass}`}
