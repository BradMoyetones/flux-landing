...
const STEPS = [
    {
        ...
        label: 'Trigger',
        title: 'HTTP Request',
        description: 'Escucha webhooks, peticiones REST o eventos programados. El pipeline arranca aquí.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
    ...
    },
    {
        ...
        description: 'Parsea, filtra y reestructura. Los datos fluyen por validadores y funciones puras.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
    ...
    },
    {
        ...
        description: 'Bifurca el flujo con lógica condicional. Switch, if/else y evaluaciones dinámicas.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
    ...
    },
    {
        ...
        description: 'Dispara acciones: notificaciones push, persistencia en DB o llamadas a APIs externas.',
        icon: (
            <svg
                viewBox="0 0 24 24"
                fill="none"
...
const CONNECTOR_PHRASES = ['Los datos fluyen →', 'Cada paso suma contexto →', 'Acción inmediata →'];
...
export function WorkflowDemo() {
    ...
    useGSAP(
        () => {
            ...
            track.querySelectorAll<HTMLElement>('[data-conn-phrase]').forEach((phrase) => {
                gsap.fromTo(
                    phrase,
                    { autoAlpha: 0, x: -10 },
                    {
            ...
            track.querySelectorAll<HTMLElement>('[data-step-phrase]').forEach((phrase) => {
                gsap.fromTo(
                    phrase,
                    { autoAlpha: 0, y: 12 },
                    {
            ...
            <div ref={trackRef} className="flex h-full items-center">
                ...
                <div className="flex h-full w-screen shrink-0 flex-col items-center justify-center px-8 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-md text-sm text-muted-foreground sm:text-base">
                        Cada paso del pipeline se ejecuta secuencialmente. El contexto fluye de un nodo al siguiente.
                    </p>
                    {/* Scroll indicator */}
                ...
                <div className="flex h-full w-[85vw] shrink-0 items-center justify-center px-8 sm:w-[65vw] md:w-[50vw]">
                    <div data-outro className="invisible flex flex-col items-center gap-4 text-center">
                        {/* Success icon */}
                        ...
                        <h3 className="text-xl font-bold text-foreground sm:text-2xl">Pipeline completado</h3>
                        <p className="max-w-xs text-sm text-muted-foreground">
                            Todo el contexto preservado de principio a fin. Sin pérdida de datos, sin estados
                            compartidos.
                        </p>
                    </div>
                </div>
